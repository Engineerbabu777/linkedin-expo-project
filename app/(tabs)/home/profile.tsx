...
const profile = () => {
  ...
  const fetchUserProfile = async () => {
    try {
      const response = await axios.get(`http://${HOST}:3000/profile/${userId}`);
      ...
      >
        <Pressable>
          <Image
            ...
            source={{ uri: user?.profileImage || "https://www.pngall.com/wp-content/uploads/5/Profile-Male-PNG.png"}}
